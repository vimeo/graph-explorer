<ul>
    ...
    <li>allow "or" style matches across groups of patterns,like so: cpu iowait dfs || template=udp dfs1. maybe this can be integrated with the above</li>
    ...
    <li>rename templates to plugins</li>
    ...
    <li>allow templates to yield targets without corresponding to particular metrics. i.e. for statsd this is useful:
