...
class ConfigValidator(Form):
    ...
    es_events_host = StringField('es_host', [String_and(validators.Length(min=2))])
    es_events_port = IntegerField('es_port', [validators.NumberRange(0, 65535)])
    es_events_index = StringField('es_index', [String_and(validators.Length(min=2))])
