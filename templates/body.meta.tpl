        ...
        <div class="row">
            <div class="span4">
                <div class="alert alert-info">
                    <strong>This project can use your help!</strong>
                    <br/>Luckily for you, the code is easy to grasp and hack.
                </div>
            </div>
        </div>
        <div class="row">
            <div class="span8">
                ...
                <ul>
                    ...
                    <br/>I consider those pretty much complete for our needs here.</li>
                </ul>
                <h4>Todo list</h4>
                {{!todo}}
